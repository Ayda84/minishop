...
export default function Men() {
  ...
  const { shirts, pantsMen } = useContext(ProductContext);

  const currentItem = activeTab === "shirt" ? shirts : pantsMen;
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center justify-center gap-2">
                  ...
                  <p className="text-[10px]">{item.Inventory}</p>
                  ...
                  <div className="flex  md:flex-row flex-col items-center justify-center gap-2">
                    <div className="flex flex-row items-center justify-center gap-2 border-2  mb-1 border-maintext rounded-2xl px-2">
                      <button
                        onClick={() => addItem(productId)}
                        className="md:text-[20px] cursor-pointer border-l-2 md:px-1 border-second md:pl-2  px-2 text-[14px]"
                      >
                        +
                      </button>
                      <p>{quantity}</p>
